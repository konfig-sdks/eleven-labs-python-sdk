...
class ProjectSnapshotResponseModel(
    ...
    class MetaOapg:
        ...
        class properties:
            project_snapshot_id = schemas.StrSchema
    ...
    project_snapshot_id: MetaOapg.properties.project_snapshot_id
    project_id: MetaOapg.properties.project_id
    name: MetaOapg.properties.name
    created_at_unix: MetaOapg.properties.created_at_unix
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["project_snapshot_id"]) -> MetaOapg.properties.project_snapshot_id: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["project_snapshot_id", "project_id", "created_at_unix", "name", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["project_snapshot_id"]) -> MetaOapg.properties.project_snapshot_id: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["project_snapshot_id", "project_id", "created_at_unix", "name", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        project_snapshot_id: typing.Union[MetaOapg.properties.project_snapshot_id, str, ],
