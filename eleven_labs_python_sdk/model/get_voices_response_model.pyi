...
class GetVoicesResponseModel(
        ...
        class properties:
            ...
            class voices(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['VoiceResponseModel']:
                        return VoiceResponseModel
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['VoiceResponseModel'], typing.List['VoiceResponseModel']],
                ...
                def __getitem__(self, i: int) -> 'VoiceResponseModel':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["voices", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["voices", ], str]):
