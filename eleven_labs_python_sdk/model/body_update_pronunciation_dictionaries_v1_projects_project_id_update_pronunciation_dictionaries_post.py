...
class BodyUpdatePronunciationDictionariesV1ProjectsProjectIdUpdatePronunciationDictionariesPost(
    ...
    pronunciation_dictionary_locators: MetaOapg.properties.pronunciation_dictionary_locators
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["pronunciation_dictionary_locators", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["pronunciation_dictionary_locators"]) -> MetaOapg.properties.pronunciation_dictionary_locators: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["pronunciation_dictionary_locators", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        pronunciation_dictionary_locators: typing.Union[MetaOapg.properties.pronunciation_dictionary_locators, list, tuple, ],
        _configuration: typing.Optional[schemas.Configuration] = None,
