...
class BaseApi(api_client.Api):
    ...
    def _get_all_coupons_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _aget_all_coupons_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/admin/n8enylacgd/coupons',
            headers=_headers,
        )
...
class GetAllCouponsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_all_coupons(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._get_all_coupons_mapped_args(
        )
        return await self._aget_all_coupons_oapg(
            **kwargs,
        )
    ...
    def get_all_coupons(
        ...
        return self._get_all_coupons_oapg(
        )

class GetAllCoupons(BaseApi):
    ...
    async def aget_all_coupons(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_all_coupons(
            **kwargs,
        )
        if validate:
    ...
    def get_all_coupons(
        ...
        raw_response = self.raw.get_all_coupons(
        )
        if validate:
            return Dictionary(**raw_response.body)
        return api_client.construct_model_instance(Dictionary, raw_response.body)
