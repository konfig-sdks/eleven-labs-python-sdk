...
class BaseApi(api_client.Api):
    ...
    def _get_all_vanity_links_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _aget_all_vanity_links_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/admin/n8enylacgd/vanity-links',
            headers=_headers,
        )
    ...
    def _get_all_vanity_links_oapg(
        self,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
...
class GetAllVanityLinksRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_all_vanity_links(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._get_all_vanity_links_mapped_args(
        )
        return await self._aget_all_vanity_links_oapg(
            **kwargs,
        )
    
    def get_all_vanity_links(
        self,
    ) -> typing.Union[
        ApiResponseFor200,
        api_client.ApiResponseWithoutDeserialization,
        ...
        return self._get_all_vanity_links_oapg(
        )

class GetAllVanityLinks(BaseApi):
    ...
    async def aget_all_vanity_links(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_all_vanity_links(
            **kwargs,
        )
        if validate:
    ...
    def get_all_vanity_links(
        ...
        raw_response = self.raw.get_all_vanity_links(
        )
        if validate:
            return Dictionary(**raw_response.body)
        return api_client.construct_model_instance(Dictionary, raw_response.body)
