...
class BaseApi(api_client.Api):
    ...
    def _get_vanity_link_mapped_args(
        self,
        slug: str,
    ...
    async def _aget_vanity_link_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/admin/n8enylacgd/vanity-link/{slug}',
            headers=_headers,
        )
...
class GetVanityLinkRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_vanity_link(
        self,
        slug: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_vanity_link_mapped_args(
            slug=slug,
        )
        return await self._aget_vanity_link_oapg(
    ...
    def get_vanity_link(
        ...
        return self._get_vanity_link_oapg(
            path_params=args.path,
        )

class GetVanityLink(BaseApi):
    ...
    async def aget_vanity_link(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_vanity_link(
            slug=slug,
            **kwargs,
        )
        if validate:
    ...
    def get_vanity_link(
        ...
        raw_response = self.raw.get_vanity_link(
            slug=slug,
        )
        if validate:
            return Dictionary(**raw_response.body)
