...
ProjectSnapshotIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'project_id': typing.Union[ProjectIdSchema, str, ],
        'project_snapshot_id': typing.Union[ProjectSnapshotIdSchema, str, ],
    }
)
...
request_path_project_snapshot_id = api_client.PathParameter(
    name="project_snapshot_id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ProjectSnapshotIdSchema,
    required=True,
)
...
class BaseApi(api_client.Api):
    ...
    def _stream_audio_from_snapshot_mapped_args(
        self,
        project_id: str,
        ...
        if project_snapshot_id is not None:
            _path_params["project_snapshot_id"] = project_snapshot_id
        args.header = _header_params
        args.path = _path_params
        return args

    async def _astream_audio_from_snapshot_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            ...
            request_path_project_snapshot_id,
        ):
        ...
        request_before_hook(
            ...
            path_template='/v1/projects/{project_id}/snapshots/{project_snapshot_id}/stream',
            headers=_headers,
        )
    ...
    def _stream_audio_from_snapshot_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class StreamAudioFromSnapshotRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def astream_audio_from_snapshot(
        self,
        project_id: str,
        project_snapshot_id: str,
        xi_api_key: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._stream_audio_from_snapshot_mapped_args(
            project_id=project_id,
            project_snapshot_id=project_snapshot_id,
            xi_api_key=xi_api_key,
        )
        return await self._astream_audio_from_snapshot_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def stream_audio_from_snapshot(
        self,
        project_id: str,
        project_snapshot_id: str,
        xi_api_key: typing.Optional[str] = None,
        ...
        return self._stream_audio_from_snapshot_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class StreamAudioFromSnapshot(BaseApi):
    ...
    async def astream_audio_from_snapshot(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.astream_audio_from_snapshot(
            project_id=project_id,
            project_snapshot_id=project_snapshot_id,
            xi_api_key=xi_api_key,
            **kwargs,
    ...
    def stream_audio_from_snapshot(
        ...
        raw_response = self.raw.stream_audio_from_snapshot(
            project_id=project_id,
            project_snapshot_id=project_snapshot_id,
            xi_api_key=xi_api_key,
        )
