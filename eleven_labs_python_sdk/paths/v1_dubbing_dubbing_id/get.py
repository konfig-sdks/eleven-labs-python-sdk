...
class BaseApi(api_client.Api):
    ...
    def _get_project_metadata_mapped_args(
        self,
        dubbing_id: str,
    ...
    async def _aget_project_metadata_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/dubbing/{dubbing_id}',
            headers=_headers,
        )
    ...
    def _get_project_metadata_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetProjectMetadataRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_project_metadata(
        self,
        dubbing_id: str,
        xi_api_key: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_project_metadata_mapped_args(
            dubbing_id=dubbing_id,
            xi_api_key=xi_api_key,
        )
        return await self._aget_project_metadata_oapg(
    ...
    def get_project_metadata(
        ...
        return self._get_project_metadata_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class GetProjectMetadata(BaseApi):
