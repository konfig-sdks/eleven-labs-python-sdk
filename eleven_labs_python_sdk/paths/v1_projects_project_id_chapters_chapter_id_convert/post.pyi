...
class BaseApi(api_client.Api):
    ...
    def _start_chapter_conversion_mapped_args(
        self,
        project_id: str,
        chapter_id: str,
    ...
    async def _astart_chapter_conversion_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/projects/{project_id}/chapters/{chapter_id}/convert',
            headers=_headers,
        )
    ...
    def _start_chapter_conversion_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class StartChapterConversionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def astart_chapter_conversion(
        self,
        project_id: str,
        chapter_id: str,
        xi_api_key: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._start_chapter_conversion_mapped_args(
            project_id=project_id,
            chapter_id=chapter_id,
            xi_api_key=xi_api_key,
        )
        return await self._astart_chapter_conversion_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def start_chapter_conversion(
        self,
        project_id: str,
        chapter_id: str,
        xi_api_key: typing.Optional[str] = None,
        ...
        return self._start_chapter_conversion_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class StartChapterConversion(BaseApi):
    ...
    async def astart_chapter_conversion(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.astart_chapter_conversion(
            project_id=project_id,
            chapter_id=chapter_id,
            xi_api_key=xi_api_key,
            **kwargs,
    ...
    def start_chapter_conversion(
        ...
        raw_response = self.raw.start_chapter_conversion(
            project_id=project_id,
            chapter_id=chapter_id,
            xi_api_key=xi_api_key,
        )
