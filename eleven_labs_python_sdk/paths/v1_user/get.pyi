...
from eleven_labs_python_sdk.model.user_response_model import UserResponseModel as UserResponseModelSchema

from eleven_labs_python_sdk.type.http_validation_error import HTTPValidationError
from eleven_labs_python_sdk.type.user_response_model import UserResponseModel

from ...api_client import Dictionary
from eleven_labs_python_sdk.pydantic.user_response_model import UserResponseModel as UserResponseModelPydantic
...
SchemaFor200ResponseBodyApplicationJson = UserResponseModelSchema
...
class GetInfo(BaseApi):
    ...
    async def aget_info(
        ...
        validate: bool = False,
        **kwargs,
    ) -> UserResponseModelPydantic:
        raw_response = await self.raw.aget_info(
            xi_api_key=xi_api_key,
            **kwargs,
        )
        if validate:
            return UserResponseModelPydantic(**raw_response.body)
        return api_client.construct_model_instance(UserResponseModelPydantic, raw_response.body)
